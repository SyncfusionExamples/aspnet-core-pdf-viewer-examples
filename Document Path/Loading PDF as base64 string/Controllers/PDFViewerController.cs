...
namespace EssentialJS2WebApplication1.Controllers.PdfViewer
{
    public partial class PdfViewerController : Controller
    {
            ...
            if (jsonObject != null && jsonObject.ContainsKey("document"))
            {
                if (bool.Parse(jsonObject["isFileName"]))
                {
                    ...
                    if (!string.IsNullOrEmpty(documentPath))
                    {
                        ...
                        //Initialize a memory stream class based on the specified byte array.
        ...
        {
            PdfRenderer pdfviewer = new PdfRenderer(_cache);
            //Export the form fields value to the PDF documents.
        ...
        private string GetDocumentPath(string document)
        {
            ...
            {
                //Sets the absolute path to the directory that contains the application content files.
                string basePath = _hostingEnvironment.WebRootPath;
                var pathToFile = basePath + Path.DirectorySeparatorChar.ToString() + "Data" + Path.DirectorySeparatorChar.ToString() + document;
